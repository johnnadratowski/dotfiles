...
local defaultBrowser = 'FirefoxDeveloperEdition'

-- Application quick switching
hs.hotkey.bind(constants.hyper, '1', function() hs.application.launchOrFocus('Terminal') end)
hs.hotkey.bind(constants.hyper, '2', function() hs.application.launchOrFocus(defaultBrowser) end)
...
function google()
    ensureOpen(defaultBrowser, 3, 100000):selectMenuItem("New Tab")
end
