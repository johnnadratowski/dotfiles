...
c.InteractiveShellApp.exec_lines.append('import traceback')
c.InteractiveShellApp.exec_lines.append('import logging')
c.InteractiveShellApp.exec_lines.append('import atexit')
...
c.InteractiveShellApp.exec_lines.append('%automagic 1')
c.InteractiveShellApp.exec_lines.append('%rehashx')
c.InteractiveShellApp.exec_lines.append('%cd ~/tmp/')
...
c.TerminalInteractiveShell.banner1 = 'foo'#'Python 2.7.2 (default, Oct 27 2011, 01:40:22) \nType "copyright", "credits" or "license" for more information.\n\nIPython 0.11 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
