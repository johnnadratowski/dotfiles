...
EXTRA_FILES = {
    ...
    'claude-config/skills/agent-send': '.claude/skills/agent-send',
    'claude-config/skills/agent-msg': '.claude/skills/agent-msg',
    'claude-config/skills/agent-broadcast': '.claude/skills/agent-broadcast',
    'claude-config/skills/agent-fanout': '.claude/skills/agent-fanout',
    'claude-config/skills/agent-rename': '.claude/skills/agent-rename',
